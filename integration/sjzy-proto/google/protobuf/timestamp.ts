...
export const Timestamp: MessageFns<Timestamp> = {
  ...
  fromJSON(object: any): Timestamp {
    return {
      seconds: isSet(object.seconds) ? globalThis.String(object.seconds) : "",
  ...
  toRawObject(message: Timestamp): any {
    const obj: any = {};
    if (Object.hasOwn(message, "seconds")) {
      obj.seconds = message.seconds !== undefined ? message.seconds : message.seconds;
    }
    if (Object.hasOwn(message, "nanos")) {
      obj.nanos = message.nanos !== undefined ? message.nanos : message.nanos;
    }
    return obj;
  },
