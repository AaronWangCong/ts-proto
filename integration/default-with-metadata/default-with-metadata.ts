...
export const GetBasicRequest: MessageFns<GetBasicRequest> = {
  ...
  toJSON(message: GetBasicRequest, isProto?: boolean): unknown {
    const obj: any = {};
    const obj2: any = {};
    if (message.name !== "") {
  ...
  fromPartial<I extends Exact<DeepPartial<GetBasicRequest>, I>>(
    object: I,
...
export const GetBasicResponse: MessageFns<GetBasicResponse> = {
  ...
  toJSON(message: GetBasicResponse, isProto?: boolean): unknown {
    const obj: any = {};
    const obj2: any = {};
    if (message.name !== "") {
      obj.name = message.name;
  ...
  fromPartial<I extends Exact<DeepPartial<GetBasicResponse>, I>>(
    object: I,
    options?: { defaultZeroFields?: string[] },
  ): GetBasicResponse {
    const message = createBaseGetBasicResponse();
