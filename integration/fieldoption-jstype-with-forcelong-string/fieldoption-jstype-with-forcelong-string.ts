...
function createBaseFieldOption(): FieldOption {
  return { normalField: "", numberField: 0, stringField: "" };
}
...
export const FieldOption: MessageFns<FieldOption> = {
  ...
  fromJSON(object: any): FieldOption {
    return {
      normalField: isSet(object.normalField) ? globalThis.String(object.normalField) : "",
  ...
  toJSON(message: FieldOption, isProto?: boolean): unknown {
    ...
    if (Object.hasOwn(message, "normalField")) {
      obj2.normalField = message.normalField !== undefined ? message.normalField : message.normalField;
    }
    if (message.numberField !== 0) {
