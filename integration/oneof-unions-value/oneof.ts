    ...
    switch (object.choice?.$case) {
      ...
      case "aMessage": {
        if (object.choice?.value !== undefined && object.choice?.value !== null) {
          message.choice = {
            $case: "aMessage",
            value: PleaseChoose_Submessage.fromPartial(object.choice.value, options),
          };
        }
        break;
      }
