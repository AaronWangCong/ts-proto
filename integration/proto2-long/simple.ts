...
export const OptionalsTest: MessageFns<OptionalsTest> = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 43: {
          ...
          const _enumValue = reader.int32() as any;
          if (_enumValue !== 0) {
            message.optDefvalState = _enumValue;
          }
          continue;
        }
        case 44: {
  ...
  toJSON(message: OptionalsTest, isProto?: boolean): unknown {
    ...
    if (message.repLong) {
      obj2.rep_long = message.repLong?.map((e) => (e || Long.ZERO).toString());
    }
    ...
    if (Object.hasOwn(message, "optLong")) {
      obj2.opt_long = message.optLong !== undefined ? (message.optLong || Long.ZERO).toString() : message.optLong;
    }
    if (message.optTruth !== undefined && message.optTruth !== false) {
    ...
    if (Object.hasOwn(message, "reqLong")) {
      obj2.req_long = message.reqLong !== undefined ? (message.reqLong || Long.ZERO).toString() : message.reqLong;
    }
    if (message.reqTruth !== false) {
    ...
    if (Object.hasOwn(message, "reqDefvalLong")) {
      obj2.req_defval_long = message.reqDefvalLong !== undefined
        ? (message.reqDefvalLong || Long.fromNumber(7812378193)).toString()
    ...
    if (Object.hasOwn(message, "optDefvalLong")) {
      obj2.opt_defval_long = message.optDefvalLong !== undefined
        ? (message.optDefvalLong || Long.fromNumber(7812378193)).toString()
  ...
  fromPartial<I extends Exact<DeepPartial<OptionalsTest>, I>>(
    ...
    message.repLong = object.repLong?.map((e) => Long.fromValue(e)) as any;
    ...
    message.optLong = (object.optLong !== undefined && object.optLong !== null) ? Long.fromValue(object.optLong) : "0";
    ...
    message.reqLong = (object.reqLong !== undefined && object.reqLong !== null) ? Long.fromValue(object.reqLong) : "0";
