...
export const TimestampMessage: MessageFns<TimestampMessage> = {
  ...
  toJSON(message: TimestampMessage, isProto?: boolean): unknown {
    const obj: any = {};
    const obj2: any = {};
    if (message.timestamp !== undefined) {
    ...
    if (Object.hasOwn(message, "timestamp")) {
      obj2.timestamp = message.timestamp !== undefined
  ...
  fromPartial<I extends Exact<DeepPartial<TimestampMessage>, I>>(
    object: I,
    options?: { defaultZeroFields?: string[] },
  ): TimestampMessage {
    const message = createBaseTimestampMessage();
    message.timestamp = (object.timestamp !== undefined && object.timestamp !== null)
      ? Timestamp.fromPartial(object.timestamp, options)
      : undefined;
    return message;
  },
};
