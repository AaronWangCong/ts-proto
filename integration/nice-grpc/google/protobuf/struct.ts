...
export const Struct: MessageFns<Struct> & StructWrapperFns = {
  ...
  fromPartial(object: DeepPartial<Struct>, options?: { defaultZeroFields?: string[] }): Struct {
    const message = createBaseStruct();
...
export const Struct_FieldsEntry: MessageFns<Struct_FieldsEntry> = {
  ...
  fromPartial(object: DeepPartial<Struct_FieldsEntry>, options?: { defaultZeroFields?: string[] }): Struct_FieldsEntry {
    const message = createBaseStruct_FieldsEntry();
...
export const Value: MessageFns<Value> & AnyValueWrapperFns = {
  ...
  fromPartial(object: DeepPartial<Value>, options?: { defaultZeroFields?: string[] }): Value {
    const message = createBaseValue();
...
export const ListValue: MessageFns<ListValue> & ListValueWrapperFns = {
  ...
  fromPartial(object: DeepPartial<ListValue>, options?: { defaultZeroFields?: string[] }): ListValue {
    const message = createBaseListValue();
