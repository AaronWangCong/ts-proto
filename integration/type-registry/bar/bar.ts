...
export const Bar: MessageFns<Bar, "foo.bar.Bar"> = {
  ...
  toJSON(message: Bar, isProto?: boolean): unknown {
    const obj: any = {};
    const obj2: any = {};
    if (message.foo !== undefined) {
    ...
    if (Object.hasOwn(message, "foo")) {
      obj2.foo = message.foo !== undefined ? Foo.toJSON(message.foo, true) : message.foo;
    }
  ...
  fromPartial<I extends Exact<DeepPartial<Bar>, I>>(object: I, options?: { defaultZeroFields?: string[] }): Bar {
    const message = createBaseBar();
    message.foo = (object.foo !== undefined && object.foo !== null) ? Foo.fromPartial(object.foo, options) : undefined;
    return message;
  },
};
